...
const Header = () => {
  ...
  return (
    <div className="header text-white w-full sm:w-4/5 mx-auto flex items-center sm:px-0 px-4 justify-between">
      <div className="logo">
      ...
      <div className="sm:hidden block"><i className="bi bi-list text-2xl"></i></div>
    </div>
  );
};
